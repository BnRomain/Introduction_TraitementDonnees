...
\paragraph{Planning.} Le projet s'est étalé sur six semaines, en suivant
l'ordre logique du traitement de données (tableau~\ref{tab:planning}).
...
4 & \textit{Feature engineering}~: création et test des variables \\
5 & Régression logistique, validation, optimisation \\
6 & Rédaction du rapport et préparation de la soutenance \\
\bottomrule
\end{tabular}
\end{table}
